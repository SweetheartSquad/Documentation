...
\begin{abstract}
In this study, we examined whether the effects of autonomous sensory meridian response (ASMR) can be triggered with more frequency or effectiveness through the addition of immersive VR. Ten users participated in the study (one user was excluded from the data analysis) and were subjected to an AB test. One of the tests exposed users to a traditional ASMR audio experience while the other used this same audio in addition to an interactive virtual reality system. Based on data gained via a user questionnaire it was determined that an interactive virtual reality experience does not increase the frequency of ASMR. In fact, the data suggests that virtual reality distracts the user from the audio source and hinders the ASMR experience.
